...
That means that if we take the distance between A and B and call it r, then if the distance A-C < r AND the distance B-C < r then there is no edge between A and B.
*/

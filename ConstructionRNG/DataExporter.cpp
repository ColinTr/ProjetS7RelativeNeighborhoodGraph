...
void DataExporter::ExportNodes(FileData & dataMatrix, TravelAlgorithmResult resultSet, std::string nomFichier)
{
    ...
    if (fichier.is_open()) {
        ...
        fichier << dataMatrix.getSeparationCharacter() << "\"Found again when inserted\""
            ...
            << dataMatrix.getSeparationCharacter() << "\"Mean travel distance\""
            << dataMatrix.getSeparationCharacter() << "\"Min travel distance\""
            << dataMatrix.getSeparationCharacter() << "\"Max travel distance\""
